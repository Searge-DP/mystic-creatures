...
public class GuiSpecialsSelect extends GuiScreen
{
	...
	public void initGui()
	{
		...
		for (final EnumModel antler : EnumModel.getAntlers())
		{
		...
		for (final EnumModel horn : EnumModel.getHorns())
		{
		...
		for (final EnumModel ear : EnumModel.getEars())
		{
	...
	public void drawScreen(int sizeX, int sizeY, float offset)
	{
		...
		final int posX = width / 2 + 150;
		final int posY = height / 2 + 85;
		final int scale = 80;
		...
		GL11.glPushMatrix();
		{
			...
			final float yawOffset = player.renderYawOffset;
